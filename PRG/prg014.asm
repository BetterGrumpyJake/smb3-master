...
LL_TopBlock:
	...
	;springldc makes frozen munchers in all tilesets
	;.byte TILE1_WATERBUMPS1,  TILE1_DIAMOND,    TILE1_SANDTOP,   TILE3_QUICKSAND_TOP
	.byte TILEA_FROZENMUNCHER,  TILE1_DIAMOND,    TILEA_FROZENCOIN,   TILE3_QUICKSAND_TOP

	; This array specifies what blocks will follow
LL_FollowBlock:
	.byte TILE1_WFALLMID,     TILE1_WATER,      TILE1_WATER,     TILE1_WATER
	;springldc makes frozen coins in all tilesets
	;.byte TILE1_WATERBUMPSSH, TILE1_DIAMOND,    TILE1_SANDMID,   TILE3_QUICKSAND_MID
	.byte TILEA_FROZENMUNCHER, TILE1_DIAMOND,    TILEA_FROZENCOIN,   TILE3_QUICKSAND_MID
